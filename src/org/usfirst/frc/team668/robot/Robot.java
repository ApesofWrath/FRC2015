...
//	public static RobotDrive robotDrive; FIXX
	...
	public void robotInit() {
		...
		// Same with Elevator speed chooser. We will use this to find the optimal elevator speed
		elevatorChooser = new SendableChooser();
		elevatorChooser.addDefault("0.2", 0.2);
		for(double i = 0.1; i <= 1.0; i+= 0.1) { // {0.1,0.2 ... 0.9,1.0}
			elevatorChooser.addObject(i + "", i); // The  + "" is necessary because it tells the computer to do String math
		}
